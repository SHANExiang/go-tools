...
const (
	HelloServer_SayHello_FullMethodName = "/HelloServer/SayHello"
	HelloServer_SayName_FullMethodName  = "/HelloServer/SayName"
)
...
type HelloServerClient interface {
	...
	SayName(ctx context.Context, in *NameReq, opts ...grpc.CallOption) (*NameRep, error)
}
...
func (c *helloServerClient) SayHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRep, error) {
	out := new(HelloRep)
	err := c.cc.Invoke(ctx, HelloServer_SayHello_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServerClient) SayName(ctx context.Context, in *NameReq, opts ...grpc.CallOption) (*NameRep, error) {
	out := new(NameRep)
	err := c.cc.Invoke(ctx, HelloServer_SayName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServerServer interface {
	...
	SayName(context.Context, *NameReq) (*NameRep, error)
...
func (UnimplementedHelloServerServer) SayHello(context.Context, *HelloReq) (*HelloRep, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
func (UnimplementedHelloServerServer) SayName(context.Context, *NameReq) (*NameRep, error) {
...
func _HelloServer_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloServer_SayHello_FullMethodName,
	}
...
func _HelloServer_SayName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloServer_SayName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
